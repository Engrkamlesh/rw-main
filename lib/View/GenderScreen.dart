...
import 'package:rw/View/AgeScreen.dart';
...
class _GenderScreenState extends State<GenderScreen> {
  ...
  Widget custom(String text, int index) {
    return GestureDetector(
      ...
      child: CircleAvatar(
        radius: 40,
        backgroundColor: selectContainer == 1 ? Colors.red : Colors.white,
        child: Column(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //   color: Colors.grey,
                    //   textColro: Colors.grey,
                    //   onpress: () {},
                    // ).centered().pOnly(bottom: 40),
                    custom("MAle", 1).centered().pOnly(bottom: 30),
                    custom("Female", 2).centered(),
                    RowBtn(
                      onpress: () {
                        Get.back();
                      },
