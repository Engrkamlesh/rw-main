...
import 'package:rw/View/weeklyTraningScreen.dart';
        ...
        child: Row(children: [
          SizedBox(
              ...
              child: Column(
                ...
                children: [
                  "Guardians".text.bold.color(Color(0xFFD1B000)).size(28).make(),
                  Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          "OF".text.bold.color(Color(0xFFD1B000)).size(14).make(),
                          "THE".text.color(Color(0xFFD1B000)).bold.size(14).make()
                        ],
                      ),
