...
import 'package:rw/View/workoutPlan.dart';
            ...
            Container(
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                "joined".text.color(Colors.white).make().pOnly(top: 15),
                                "2 mon ago"
                                    .text
                                    .color(Colors.white)
                                    .size(16)
                    ...
                    const tile(
                      text: "Edit Profile", icon: Icons.arrow_forward_ios,
                    ),
                    const Divider(
                      color: Colors.grey,
                    ),
                    ...
                    const tile(
                      text: "Setting",icon: Icons.arrow_forward_ios,
                    ),
                    Container(
                   ...
                   tile(text: "Sign Out", color: Colors.red,),
                    const Divider(
                      color: Colors.grey,
                    ),
                  ],
...
class tile extends StatelessWidget {
  const tile({super.key, required this.text, this.color = Colors.white, this.onpress,
   this.icon});
  final String text;
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Text(text, style: TextStyle(color: color, fontSize: 14),),
      trailing: Icon(
        icon,
        color: Colors.white
      ),
